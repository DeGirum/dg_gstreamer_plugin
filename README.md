...
Find your system's CUDA version:

```nvcc --version```

*Edit the line in the Makefile to set the variable CUDA_VER to your system's CUDA version.*


Enter the folder and install:

```cd dg_gstreamer_plugin/dgaccelerator && sudo make install```
